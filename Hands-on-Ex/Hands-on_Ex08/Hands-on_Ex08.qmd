...
bw_adaptive <- read_rds(
  "chap14/data/model/bw_adaptive.rds")
```
...
write_rds(gwr_adaptive, 
          "chap14/data/model/gwr_adaptive.rds")
```
...
write_rds(gwr_bw_test_adaptive, 
          "chap14/data/model/gwr_bw_test_adaptive.rds")
```
...
coords_train <- write_rds(
  coords_train, 
  "chap14/data/model/coords_train.rds" )
coords_test <- write_rds(
  coords_test, 
  "chap14/data/model/coords_test.rds" )
```
